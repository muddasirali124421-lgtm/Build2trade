      ...
      <div className="section-padding max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Built From Real{' '}
              <span className="gradient-text">Industry Problems</span>
            </motion.h2>
            ...
            >
              Build2Trade is a construction-tech platform designed by builders, for builders. 
              We understand the daily challenges of finding reliable tradies, managing quotes, 
            ...
            >
              Our platform connects builders with verified subcontractors across Australia, 
              streamlining communication and helping you complete projects faster and more efficiently.
            </motion.p>
